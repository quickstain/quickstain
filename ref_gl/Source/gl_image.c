...
#define MAX_TEXTURE_DIMENSIONS 2048 // staincatcher // 9060

typedef struct // staincatcher // 9060
{ 
	byte *Buffer;
	size_t Pos;
} TPngFileBuffer;

void PngReadFunc(png_struct *Png, png_bytep buf, png_size_t size) // staincatcher // 9060
{
...
void LoadPNG(const char *name, byte **pic, int *width, int *height) // staincatcher // 9060
{
...
void jpg_null(j_decompress_ptr cinfo) // staincatcher // 9060
{
}

boolean jpg_fill_input_buffer(j_decompress_ptr cinfo) // staincatcher // 9060
{
	ri.Con_Printf(PRINT_ALL, "Premature end of JPEG data.\n");
	return 1;
}

void jpg_skip_input_data(j_decompress_ptr cinfo, long num_bytes) // staincatcher // 9060
{
...
void jpeg_mem_src(j_decompress_ptr cinfo, byte *mem, int len) // staincatcher // 9060
{
...
void LoadJPG(char *filename, byte **pic, int *width, int *height) // staincatcher // 9060
{
...
================
*/
image_t *GL_LoadWal(const char *name, const char *filename) // staincatcher // 9060
{
	miptex_t	*mt;
...
image_t *GL_LoadImage(const unsigned char *name, imagetype_t type) // staincatcher // 9060
{
...
image_t	*GL_FindImage(const char *name, imagetype_t type) // staincatcher // 9060
{
	image_t	*image = NULL;
	int		i, len;
	const char *in;
